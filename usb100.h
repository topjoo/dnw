...
typedef struct _USB_DEVICE_DESCRIPTOR {
    ...
    UCHAR bMaxPacketSize0;    /// USB_OTG_MAX_EP0_SIZE
    USHORT idVendor;
	
    USHORT idProduct;         /// 0x00 : bcdDevice rel. 2.00
    USHORT bcdDevice;         /// 0x02
    UCHAR iManufacturer;      /// USBD_IDX_MFC_STR
    UCHAR iProduct;           /// USBD_IDX_PRODUCT_STR
    UCHAR iSerialNumber;      /// USBD_IDX_SERIAL_STR
    UCHAR bNumConfigurations; /// USBD_CFG_MAX_NUM
