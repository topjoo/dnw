...
extern int Pad_Byte;
extern int Enable_Checksum_Error;
extern int Status_Checksum_Error;
...
extern int Module;
extern int Minimum_Block_Size_Setted;
extern int Starting_Address_Setted;
extern int Max_Length_Setted;
extern int Swap_Wordwise;
extern int Address_Alignment_Word;
...
extern int Cks_range_set;
extern int Cks_Addr_set;
extern int Force_Value;

extern unsigned int Crc_Poly, Crc_Init, Crc_XorOut;
extern int Crc_RefIn;
extern int Crc_RefOut;
